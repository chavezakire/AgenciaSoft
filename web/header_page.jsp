...
<div class="top">
    <div class="container">         
        <ul class="loginbar pull-right">
            ...
            <li><a href="page_login.jsp">Login</a></li>   
        </ul>
    </div>      
</div><!--/top-->
<!--=== End Top ===-->    
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="index.jsp" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">
                            HOME
                        </a>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a href="page_contact1.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">
                            CONTACTO
                        </a>
                    </li>                    
